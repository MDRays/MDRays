...
- **Data Engineering**: Apache Airflow, ETL Automation, Docker, MongoDB, PostgreSQL, PySpark 
- **Data Analysis & Visualization**: Tableau, Looker Studio, Pandas, Matplotlib, Seaborn 
- **Machine Learning & AI**: Regression, Random Forest, Decision Trees, Clustering, Time Series (ARIMA) 
- **Tools**: Visual Studio Code, Conda, Google BigQuery 
